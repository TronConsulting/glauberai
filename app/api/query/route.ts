...
const EXPOSE_ROUTING_DETAILS =
  process.env.SHOW_ROUTING_DETAILS === 'true' ||
  process.env.NEXT_PUBLIC_SHOW_ROUTING_DETAILS === 'true';
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const routingDetails = EXPOSE_ROUTING_DETAILS
      ? {
        model: result.finalModel,
