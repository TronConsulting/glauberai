...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    try {
      ...
      result = await aiRouter.processQuery(
        enhancedQuery, 
    ...
    let contextInfo = `\\n\\n---\\n*Generated by ${result.finalModel} | Category: ${result.routing.analysis.type} | Confidence: ${(result.routing.confidence * 100).toFixed(0)}%*`;
    ...
    return NextResponse.json({
      ...
      queryAnalysis: result.routing.analysis,
      modelCapabilities: {
